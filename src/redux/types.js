...
export const GET_PENDING_POST_BY_ID = 'GET_PENDING_POST_BY_ID';
export const APPROVE_POST = 'APPROVE_POST';
export const DELETE_POST_BY_ADMIN = 'DELETE_POST_BY_ADMIN';
export const SET_LOADING_PENDING_POSTS = 'SET_LOADING_PENDING_POSTS';
export const PENDING_POST_ERROR = 'PENDING_POST_ERROR';
...
export const SET_LOADING_BLOOD_DONORS = 'SET_LOADING_BLOOD_DONORS';
